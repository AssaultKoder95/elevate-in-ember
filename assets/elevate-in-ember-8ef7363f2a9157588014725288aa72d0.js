...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("elevate-in-ember/app").default.create({name:"elevate-in-ember",version:"0.0.0+1e84ab83"})
